...
// const getInfo = inventors.map((inventor) => [inventor.first, inventor.last]);
...
// const fullYears = inventors.reduce((totale,inventor) => {return totale+(inventor.passed-inventor.year)},0)
// console.log(fullYears);

//! 5. Sort the inventors by years lived
// const sortFullYears = inventors.sort((a, b) => {
//     const prevInv = a.passed - a.year;
//     const nextInv = b.passed - b.year;
//     return prevInv > nextInv ? 1 : -1
// })
// console.log(sortFullYears);


//! 6. create a list of Boulevards in Paris that contain 'de' anywhere in the name
// https://en.wikipedia.org/wiki/Category:Boulevards_in_Paris
// const container = document.querySelector('.mw-category') ;
// const links = container.querySelectorAll('a');     Arrray.from() = [...]
// t = [...links].map((e)=>e.textContent).filter((e)=>e.includes('de'))
// console.table(t);
